        ...
        def get_environ(self, request):
            ...
            if request.body is not None:
                if hasattr(request.body, 'read'):
                    kwargs['raw_data'] = request.body.read()
                else:
                    kwargs['raw_data'] = request.body
...
class APIRequestFactory(DjangoRequestFactory):
    ...
    def _encode_data(self, data, format=None, content_type=None):
        """
        Encode the raw_data returning a two tuple of (bytes, content_type)
        """
        ...
        if content_type:
            # Content type specified explicitly, treat raw_data as a raw bytestring
            ...
            # Use format and render the raw_data into a bytestring
    ...
    def generic(self, method, path, data='',
        ...
        # Include the CONTENT_TYPE, regardless of whether or not raw_data is empty.
