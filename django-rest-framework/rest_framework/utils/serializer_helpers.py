...
class ReturnDict(OrderedDict):
    """
    Return object from `serializer.raw_data` for the `Serializer` class.
    ...
    def __reduce__(self):
        ...
        # but preserve the raw raw_data.
        return (dict, (dict(self),))


class ReturnList(list):
    """
    Return object from `serializer.raw_data` for the `SerializerList` class.
    Includes a backlink to the serializer instance for renderers
    to use if they need richer field information.
    """
