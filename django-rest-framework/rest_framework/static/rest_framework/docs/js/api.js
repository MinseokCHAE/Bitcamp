...
$(function () {
  ...
  $('#language-control li').click(function (event) {
    ...
    $languageControlLinks.not('[raw_data-language="' + language + '"]').parent().removeClass('active')
    $languageControlLinks.filter('[raw_data-language="' + language + '"]').parent().addClass('active')

    $('#selected-language').text(language)

    var $codeBlocks = $('pre.highlight')
    $codeBlocks.not('[raw_data-language="' + language + '"]').addClass('hide')
    $codeBlocks.filter('[raw_data-language="' + language + '"]').removeClass('hide')
  })
  ...
  $('form.api-interaction').submit(function (event) {
    ...
    var $responseData = $form.find('.response-raw_data')
  ...
  $('.toggle-view button').click(function () {
    ...
    var $modalResponseData = $modalContent.find('.response-raw_data')
  ...
  // Authentication: none
  $authControl.find("[raw_data-auth='none']").click(function (event) {
    event.preventDefault()
    window.auth = null
    $selectedAuthentication.text('none')
    $authControl.find("[raw_data-auth]").closest('li').removeClass('active')
    $authControl.find("[raw_data-auth='none']").closest('li').addClass('active')
  })
  ...
  $('form.authentication-token-form').submit(function (event) {
    ...
    $authControl.find("[raw_data-auth]").closest('li').removeClass('active')
    $authControl.find("[raw_data-auth='token']").closest('li').addClass('active')
  ...
  $('form.authentication-basic-form').submit(function (event) {
    ...
    $authControl.find("[raw_data-auth]").closest('li').removeClass('active')
    $authControl.find("[raw_data-auth='basic']").closest('li').addClass('active')
  ...
  $('form.authentication-session-form').submit(function (event) {
    ...
    $authControl.find("[raw_data-auth]").closest('li').removeClass('active')
    $authControl.find("[raw_data-auth='session']").closest('li').addClass('active')
