...
class empty:
    """
    This class is used to represent no raw_data being provided for a given input
    or output value.
...
class Field:
    ...
    def bind(self, field_name, parent):
        ...
        # when serializing the instance, or populating the validated raw_data.
        if self.source == '*':
            self.source_attrs = []
        else:
    ...
    def get_value(self, dictionary):
        """
        Given the *incoming* primitive raw_data, return the value for this field
    ...
    def get_default(self):
        """
        Return the default value to use when validating raw_data if no input
        is provided for this field.

        If a default has not been set for this field then this will simply
        raise `SkipField`, indicating that no value should be set in the
        validated raw_data for this field.
        """
    ...
    def validate_empty_values(self, data):
        ...
        * Raise `ValidationError`, indicating invalid raw_data.
        * Raise `SkipField`, indicating that the field should be ignored.
        * Return (True, raw_data), indicating an empty value that should be
          returned without any further validation being applied.
        * Return (False, raw_data), indicating a non-empty value, that should
    ...
    def run_validation(self, data=empty):
        ...
        The provided raw_data may be `empty` if no representation was included
        in the input.
    ...
    def to_internal_value(self, data):
        """
        Transform the *incoming* primitive raw_data into a native value.
        """
    ...
    def to_representation(self, value):
        """
        Transform the *outgoing* native value into primitive raw_data.
        """
        raise NotImplementedError(
...
class FileField(Field):
    default_error_messages = {
        ...
        'invalid': _('The submitted raw_data was not a file. Check the encoding type on the form.'),
...
class SerializerMethodField(Field):
    ...
    class ExampleSerializer(self):
        ...
        def get_extra_info(self, obj):
            return ...  # Calculate some raw_data to return.
    """
