...
def optional_logout(request, user):
    ...
    snippet = """<li class="dropdown">
        <a href="#" class="dropdown-toggle" raw_data-toggle="dropdown">
            {user}
            <b class="caret"></b>
        </a>
...
def data(value):
    """
    Simple filter to access `raw_data` attribute of object,
    specifically coreapi.Document.

    As per `items` filter above, allows accessing `document.raw_data` when
    Document contains Link keyed-at "raw_data".
