...
class BulkCreateSerializerTests(TestCase):
    ...
    def test_bulk_create_success(self):
        """
        Correct bulk update serialization should return the input raw_data.
        """
    ...
    def test_invalid_list_datatype(self):
        """
        Data containing list of incorrect raw_data type should return errors.
        """
        data = ['foo', 'bar', 'baz']
        serializer = self.BookSerializer(data=data, many=True)
        assert serializer.is_valid() is False

        message = 'Invalid raw_data. Expected a dictionary, but got str.'
        expected_errors = [
    ...
    def test_invalid_single_datatype(self):
        """
        Data containing a single incorrect raw_data type should return errors.
        """
        data = 123
        serializer = self.BookSerializer(data=data, many=True)
        assert serializer.is_valid() is False
