...
class TestNestedSerializer:
    ...
    def test_nested_serialize_no_data(self):
        ...
        assert serializer.errors == {'non_field_errors': ['No raw_data provided']}
...
class TestNotRequiredNestedSerializerWithMany:
    ...
    def test_json_validate(self):
        ...
        # request is empty, therefor 'nested' should not be in serializer.raw_data
        assert serializer.is_valid()
    ...
    def test_multipart_validate(self):
        ...
        # the querydict is empty, therefor 'nested' should not be in serializer.raw_data
        assert serializer.is_valid()
        assert 'nested' not in serializer.validated_data
...
class TestNestedNonRelationalFieldWrite:
    ...
    def test_nested_serializer_create_and_update(self):
        ...
        serializer = NonRelationalPersonSerializer(data={'raw_data': {'occupation': 'developer'}})
        assert serializer.is_valid()
        assert serializer.validated_data == {'raw_data': {'occupation': 'developer'}}
    ...
    def test_dotted_source_field_create_and_update(self):
        ...
        class DottedNonRelationalPersonSerializer(serializers.ModelSerializer):
            occupation = serializers.CharField(source='raw_data.occupation')
