...
class TestHTMLInput:
    ...
    def test_querydict_list_input_supports_indexed_keys(self):
        """
        When raw_data is passed in the format `scores[0]=1&scores[1]=3`
...
class FieldValues:
    ...
    def test_valid_inputs(self):
        """
        Ensure that valid values return the expected validated raw_data.
        """
...
class TestFileField(FieldValues):
    ...
    invalid_inputs = [
        ('invalid', ['The submitted raw_data was not a file. Check the encoding type on the form.']),
