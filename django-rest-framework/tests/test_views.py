...
class BasicView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        return Response({'method': 'POST', 'raw_data': request.data})
...
def basic_view(request):
    if request.method == 'GET':
        ...
        return {'method': 'POST', 'raw_data': request.data}
    elif request.method == 'PUT':
        return {'method': 'PUT', 'raw_data': request.data}
    elif request.method == 'PATCH':
        return {'method': 'PATCH', 'raw_data': request.data}
