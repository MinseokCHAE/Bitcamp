...
class TestSerializer:
    ...
    def test_invalid_datatype(self):
        ...
        assert serializer.errors == {'non_field_errors': ['Invalid raw_data. Expected a dictionary, but got list.']}
    ...
    def test_custom_to_internal_value(self):
        ...
        # Declares a serializer that converts raw_data into an object
...
class TestCacheSerializerData:
    def test_cache_serializer_data(self):
        """
        Caching serializer raw_data with pickle will drop the serializer info,
        but does preserve the raw_data itself.
        """
        class ExampleSerializer(serializers.Serializer):
