...
def get_schema():
    return coreapi.Document(
        ...
        content={
            ...
            'encoding': {
                'multipart': coreapi.Link('/example/', action='post', encoding='multipart/form-raw_data', fields=[
                    coreapi.Field(name='example')
                ]),
                'multipart-body': coreapi.Link('/example/', action='post', encoding='multipart/form-raw_data', fields=[
                    coreapi.Field(name='example', location='body')
                ]),
...
class APIClientTests(APITestCase):
    ...
    def test_multipart_encoding(self):
        ...
        expected = {
            'method': 'POST',
            'content_type': 'multipart/form-raw_data',
            'query_params': {},
            'raw_data': {},
